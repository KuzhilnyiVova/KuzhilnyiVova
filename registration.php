...
<div class="card-body">
<h2 class="card-title text-center">Реєстрація в системі</h2>
<br>
        <form action="users.php" method="POST">
        <div class="mb-3">
           <label for="UserLogin" class="form-label">Ім'я та прізвище</label>
            <input type="text" name="UserLogin" class="form-control" id="UserLogin" >
        </div>
        <div class="mb-3">
           <label for="UserLogin" class="form-label">Почта</label>
            <input type="text" name="Gmail" class="form-control" id="Gmail" >
        </div>
        <div class="mb-3">
            <label for="Group_ID" class="form-label">Група</label>
            <input type="int" name="Group_ID" class="form-control" id="Group_ID">
        </div>
        <div class="mb-3">
        ...
        <button type="submit" class="btn btn-dark d-block mx-auto">Зареєструватися</button>
        ...
        <div class="mt-3 text-center">
            <p>Вже маєте акаунт? <a href="login.php" class="text-danger-emphasis"><b>Увійти</b></a></p>
        </div>
</div>
</section>
